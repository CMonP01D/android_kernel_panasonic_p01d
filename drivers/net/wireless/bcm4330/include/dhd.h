...
enum dhd_bus_wake_state {
    ...
    WAKE_LOCK_SOFTAP_ALWAYS_WAKE, //yuhaipeng
	WAKE_LOCK_MAX
};
...
typedef struct dhd_cmn {
	...
	#if defined(CONFIG_PM_SLEEPxxxYuhaipeng)
...
//	#define DHD_PM_RESUME_RETURN_ERROR(a)	do { if (dhd_mmc_suspend) return a; } while (0)
	#define DHD_PM_RESUME_RETURN_ERROR(a)	do { if (dhd_mmc_suspend) {printk("-PM_RESUME_WAIT timeout--%s---%d---\n",__func__,__LINE__);return a;} } while (0)
